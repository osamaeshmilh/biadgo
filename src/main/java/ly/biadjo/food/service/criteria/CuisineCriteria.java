...
/**
 * Criteria class for the {@link ly.biadjo.food.domain.Cuisine} entity. This class is used
 * in {@link ly.biadjo.food.web.rest.CuisineResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cuisines?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CuisineCriteria implements Serializable, Criteria {
    ...
    public CuisineCriteria(CuisineCriteria other) {
    ...
    @Override
    public CuisineCriteria copy() {
        return new CuisineCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CuisineCriteria that = (CuisineCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, nameAr, nameEn, isActive, distinct);
    }
