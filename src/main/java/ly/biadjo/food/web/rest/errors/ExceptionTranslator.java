...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ly.biadjo.food.service.EmailAlreadyUsedException ||
            ex instanceof ly.biadjo.food.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof ly.biadjo.food.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "ly.biadjo.food");
    }
}
