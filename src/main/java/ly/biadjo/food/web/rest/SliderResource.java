...
import ly.biadjo.food.service.SliderQueryService;
import ly.biadjo.food.service.SliderService;
...
/**
 * REST controller for managing {@link ly.biadjo.food.domain.Slider}.
 */
@RestController
@RequestMapping("/api")
public class SliderResource {
    ...
    public ResponseEntity<SliderDTO> partialUpdateSlider(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sliderDTO.getId().toString())
        );
    }
