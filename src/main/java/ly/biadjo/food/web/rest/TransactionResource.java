...
import ly.biadjo.food.service.TransactionQueryService;
import ly.biadjo.food.service.TransactionService;
...
/**
 * REST controller for managing {@link ly.biadjo.food.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
