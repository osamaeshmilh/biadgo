...
describe('Restaurant Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'restaurant', component: RestaurantComponent}]),
  ...
  describe('trackId', () => {
    it('Should forward to restaurantService', () => {
      const entity = {id: 123};
      jest.spyOn(service, 'getRestaurantIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRestaurantIdentifier).toHaveBeenCalledWith(entity);
