...
import {EntityArrayResponseType, RestaurantService} from '../service/restaurant.service';
...
export class RestaurantComponent implements OnInit {
  ...
  trackId = (_index: number, item: IRestaurant): number => this.restaurantService.getRestaurantIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.restaurants = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IRestaurant[] | null): IRestaurant[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.restaurantService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
