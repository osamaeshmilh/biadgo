...
import {EntityArrayResponseType, CouponService} from '../service/coupon.service';
...
export class CouponComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICoupon): number => this.couponService.getCouponIdentifier(item);
