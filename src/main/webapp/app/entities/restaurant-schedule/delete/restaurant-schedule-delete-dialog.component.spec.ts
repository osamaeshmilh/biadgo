...
import {RestaurantScheduleDeleteDialogComponent} from './restaurant-schedule-delete-dialog.component';
...
describe('RestaurantSchedule Management Delete Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RestaurantScheduleDeleteDialogComponent],
