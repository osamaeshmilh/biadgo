...
describe('AppSetting Management Component', () => {
  let comp: AppSettingComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'app-setting', component: AppSettingComponent}]),
      ...
      .overrideTemplate(AppSettingComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to appSettingService', () => {
      const entity = {id: 123};
      jest.spyOn(service, 'getAppSettingIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAppSettingIdentifier).toHaveBeenCalledWith(entity);
