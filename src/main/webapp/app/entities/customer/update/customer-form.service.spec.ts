      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            googleId: expect.any(Object),
            facebookId: expect.any(Object),
            appleId: expect.any(Object),
            isBanned: expect.any(Object),
            isVerified: expect.any(Object),
            verifiedByEmail: expect.any(Object),
            verifiedByMobileNo: expect.any(Object),
            walletPublicKey: expect.any(Object),
