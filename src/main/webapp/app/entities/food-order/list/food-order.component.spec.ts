...
describe('FoodOrder Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'food-order', component: FoodOrderComponent}]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.foodOrders?.[0]).toEqual(expect.objectContaining({id: 123}));
  });

  describe('trackId', () => {
    it('Should forward to foodOrderService', () => {
      const entity = {id: 123};
      jest.spyOn(service, 'getFoodOrderIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFoodOrderIdentifier).toHaveBeenCalledWith(entity);
