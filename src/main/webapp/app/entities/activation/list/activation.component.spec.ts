...
describe('Activation Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'activation', component: ActivationComponent}]),
      ...
      .overrideTemplate(ActivationComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to activationService', () => {
      const entity = {id: 123};
      jest.spyOn(service, 'getActivationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getActivationIdentifier).toHaveBeenCalledWith(entity);
