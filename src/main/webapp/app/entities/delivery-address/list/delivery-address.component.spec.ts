...
describe('DeliveryAddress Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'delivery-address', component: DeliveryAddressComponent}]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.deliveryAddresses?.[0]).toEqual(expect.objectContaining({id: 123}));
  });

  describe('trackId', () => {
    it('Should forward to deliveryAddressService', () => {
      const entity = {id: 123};
      jest.spyOn(service, 'getDeliveryAddressIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeliveryAddressIdentifier).toHaveBeenCalledWith(entity);
